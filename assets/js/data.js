...
export const HERO_SLIDES = [
    {
        ...
        videoUrl: null,
        imageUrl: "assets/img/_MG_6845.webp",
    ...
    },
    {
        ...
        videoUrl: null,
        imageUrl: "assets/img/_MG_6806.webp",
    ...
    },
    {
        ...
        videoUrl: null,
        imageUrl: "assets/img/_MG_6834.webp",
    ...
    },
    {
        ...
        videoUrl: null,
        imageUrl: "assets/img/_MG_6820.webp",
    ...
    },
    {
        ...
        videoUrl: null,
        imageUrl: "assets/img/_MG_6862_1.webp",
        imageAlt: "Câmera de videomonitoramento IP instalada pela Firecam"
    }
];

export const CLIENT_LOGOS = [
    { name: 'Ciser', url: 'public/logos/ciser.svg', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'BYD', url: 'public/logos/byd.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'Copobras', url: 'public/logos/copobras.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'Petrobras', url: 'public/logos/Petrobras_horizontal_logo.svg', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'Capital Realty', url: 'public/logos/capital_realty.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'ArcelorMittal', url: 'public/logos/arcelormittal.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'Ailos', url: 'public/logos/ailos.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'DVA', url: 'public/logos/dva.png', className: 'h-10 md:h-16 w-auto object-contain' },
    { name: 'Britânia', url: 'public/logos/britania.png', className: 'h-10 md:h-16 w-auto object-contain' }
];
